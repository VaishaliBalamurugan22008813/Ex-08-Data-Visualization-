...
Find the relation between sales and profit based on the
following category.
Segment
City
...
sc=RobustScaler()
df5=pd.DataFrame(sc.fit_transform(df4),columns=['Ship Mode', 'Segment', 'City',
'State','Region',
...
```
# OUTPUT
![image](https://github.com/VaishaliBalamurugan22008813/Ex-08-Data-Visualization-/assets/119390134/d21d9c60-539b-4568-a0de-df1835c09bf6)
